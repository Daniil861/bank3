...
// В вычислениях не используется запятая - должна быть только точка. Пользователи могут вводить дробные числа с запятыми, 
// поэтому когда мы обрабатываем инпуты в которых могут быть дробные числа - нужно проверять на наличие запятой.
export function changeCommaToDot(number) {
